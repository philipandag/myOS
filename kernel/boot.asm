...
; This section will be put on the beginning of kernel file because we said so 
; in the linker script which decides how to assemble object files into the final
